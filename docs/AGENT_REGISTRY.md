...
| `SENYA` | Senya — Tech Lead & Orchestrator | Orchestration | Architecture, task breakdown via `CURRENT_TASK.md`, code review | Merge to main (coordinator); Victor pricing without review | `docs/AGENT_SENYA.md` |
