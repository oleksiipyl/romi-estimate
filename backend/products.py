...
HARDWARE_PRODUCTS = [
    ...
    {"id": "hw_lock",       "label": "Window Lock / Latch",        "description": "Sash lock, cam lock, keyed lock",      "service_id": 66, "price_min": 120, "price_max": 250, "min_charge": 350},
    {"id": "hw_hardware",   "label": "Window Hardware Repair",     "description": "Handles, hinges, general hardware",    "service_id": 62, "price_min": 350, "price_max": 450, "min_charge": 350},
    {"id": "hw_casement",   "label": "Casement Adjustment",        "description": "Sagging/misaligned sash fix",          "service_id": 69, "price_min": 650, "price_max": 650},
    {"id": "hw_screen_new", "label": "Screen Replacement",         "description": "New fiberglass/aluminum mesh screen",  "service_id": 63, "price_min": 150, "price_max": 180, "min_charge": 350},
    {"id": "hw_screen_fix", "label": "Screen Re-screen",           "description": "Re-screen existing frame",             "service_id": 64, "price_min": 80,  "price_max": 120, "min_charge": 350},
    {"id": "hw_hinge",      "label": "Hinge Replacement",          "description": "Window/door hinge replacement",         "service_id": 72, "price_min": 300, "price_max": 350, "min_charge": 350},
