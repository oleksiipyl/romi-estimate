...
PRODUCTS = {
    ...
    "residential_single": {
        ...
        "description": "Broken window, single glass pane",
    ...
    "residential_igu": {
        ...
        "description": "Insulated glass unit replacement",
        "supplier": "Western States Glass",
    ...
    "residential_foggy": {
        ...
        "category": "residential",
        "category_label": "🏠 Residential",
        "label": "Foggy IGU Replacement",
        "description": "Failed seal — cloudy/foggy glass",
        "supplier": "Western States Glass",
        "price_per_sqft_min": 28,
